              ...
              <div class="card">
                ...
                <div class="card-body">
                  <ul class="list-unstyled list-unstyled-border">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="<?php echo base_url('assets/assets_stisla')?>/assets/img/avatar/avatar-2.png" alt="avatar">
                      <div class="media-body">
                        <div class="float-right">12m</div>
                        <div class="media-title">Ages Yulia</div>
                        <span class="text-small text-muted">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin.</span>
                      </div>
                    </li>
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="<?php echo base_url('assets/assets_stisla')?>/assets/img/avatar/avatar-3.png" alt="avatar">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="<?php echo base_url('assets/assets_stisla')?>/assets/img/avatar/avatar-4.png" alt="avatar">
                      <div class="media-body">
                  ...
                  <div class="row pb-2">
                    <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                      <div class="avatar-item mb-0">
                        <img alt="image" src="<?php echo base_url('assets/assets_stisla')?>/assets/img/avatar/avatar-5.png" class="img-fluid" data-toggle="tooltip" title="Alfa Zulkarnain">
                        <div class="avatar-badge" title="Editor" data-toggle="tooltip"><i class="fas fa-wrench"></i></div>
                      </div>
                    </div>
                    <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                      <div class="avatar-item mb-0">
                        <img alt="image" src="<?php echo base_url('assets/assets_stisla')?>/assets/img/avatar/avatar-4.png" class="img-fluid" data-toggle="tooltip" title="Egi Ferdian">
                        <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i class="fas fa-cog"></i></div>
                      </div>
                    </div>
                    <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                      <div class="avatar-item mb-0">
                        <img alt="image" src="<?php echo base_url('assets/assets_stisla')?>/assets/img/avatar/avatar-1.png" class="img-fluid" data-toggle="tooltip" title="Jaka Ramadhan">
                        <div class="avatar-badge" title="Author" data-toggle="tooltip"><i class="fas fa-pencil-alt"></i></div>
                      </div>
                    </div>
                    <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                      <div class="avatar-item mb-0">
                        <img alt="image" src="<?php echo base_url('assets/assets_stisla')?>/assets/img/avatar/avatar-2.png" class="img-fluid" data-toggle="tooltip" title="Ryan">
                        <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i class="fas fa-cog"></i></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="summary">
                    ...
                    <div class="summary-item">
                      ...
                      <ul class="list-unstyled list-unstyled-border">
                        <li class="media">
                          <a href="#">
                            <img class="mr-3 rounded" width="50" src="<?php echo base_url('assets/assets_stisla')?>/assets/img/products/product-1-50.png" alt="product">
                          </a>
                          <div class="media-body">
                        ...
                        <li class="media">
                          <a href="#">
                            <img class="mr-3 rounded" width="50" src="<?php echo base_url('assets/assets_stisla')?>/assets/img/products/product-2-50.png" alt="product">
                          </a>
                          <div class="media-body">
                        ...
                        <li class="media">
                          <a href="#">
                            <img class="mr-3 rounded" width="50" src="<?php echo base_url('assets/assets_stisla')?>/assets/img/products/product-3-50.png" alt="product">
                          </a>
                          <div class="media-body">
                ...
                <div class="card-body">
                  <ul class="list-unstyled list-unstyled-border">
                    ...
                    <li class="media">
                      ...
                      <img class="mr-3 rounded-circle" width="50" src="<?php echo base_url('assets/assets_stisla')?>/assets/img/avatar/avatar-5.png" alt="avatar">
                      <div class="media-body">
                    ...
                    <table class="table table-striped mb-0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="#" class="font-weight-600"><img src="<?php echo base_url('assets/assets_stisla')?>/assets/img/avatar/avatar-1.png" alt="avatar" width="30" class="rounded-circle mr-1"> Bagus Dwi Cahya</a>
                          </td>
                          <td>
