      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?php echo base_url('admin/data_pengguna') ?>"><i class="fas fa-user"></i> <span>Data Pengguna</span></a></li>
           
            <li><a class="nav-link" href="<?php echo base_url('admin/data_penyewaan') ?>"><i class="fas fa-random"></i> <span>Data Sewa</span></a></li>
