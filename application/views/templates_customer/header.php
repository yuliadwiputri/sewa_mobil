            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <!-- <img src="<?php echo base_url()?>assets/assets_shop/img/logo.png" alt="logo"> -->
                            <!-- <h3>CARENT</h3> -->
                        </a>
                    </div>
                    <!--== Logo End ==-->
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright ml-7">
                            <ul>
                                ...
                                <?php if($this->session->userdata('nama')) { ?>
                                  ...
                                  <li><a href="<?php echo base_url('Customer/Data_Sewa')?>">Data Sewa</a></li>
